...
<div class="container">
    <form class="border border-light p-5" action="http://localhost:8080/vetplace/consultas?opcao=save&clinica=${clinica}" method="post">

        <p class="h4 mb-4 text-center">Consulta para ${paciente.nome}</p>

        <input type="hidden" id="id" name="id" value="${paciente.id}">

        <label for="data">Data/Hora</label>
        <input type="datetime-local" id="data" name="data" class="form-control mb-4" >

        <label for="descricao">Descrição</label>
        <input type="text" id="descricao" name="descricao" class="form-control mb-4">
